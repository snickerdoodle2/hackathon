...
const quizData = [
        ...
        answers: [
            {
                text: 'BIT Algo',
                isCorrect: false,
                explanation: 'Mamy ;) należy do BIT START',
            },
            {
                text: 'BIT AI',
                isCorrect: false,
                explanation: 'Mamy ;) należy do BIT PRO',
            },
            {
                text: 'BIT Java',
                isCorrect: true,
                explanation:
                    'Mamy ;) należy do BIT SOFTWARE ENGINEERING & DEVELOPMENT',
            },
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: 'Wydział Odlewnictwa',
                isCorrect: false,
                explanation: 'Prawidłowa odpowiedź to Wydział Informatyki',
            },
            {
                text: 'Wydział Energetyki',
                isCorrect: false,
                explanation: 'Prawidłowa odpowiedź to Wydział Informatyki',
            },
            {
                text: 'Wydział Humanistyczny',
                isCorrect: false,
                explanation: 'Prawidłowa odpowiedź to Wydział Informatyki',
            },
        ],
