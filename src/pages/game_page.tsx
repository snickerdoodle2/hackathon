        ...
        <div className="h-screen">
            <div className="flex justify-center items-center h-32 text-white">
                ...
                <Card className="m-2" style={{
                    background: 'linear-gradient(to right, #F48535, #F4A435)',
                }}>
                    <CardHeader>
            ...
            <div className="flex justify-center items-center flex-grow" style={{height:'calc(100% - 12rem)'}}>
                {content}
            </div>
            <div className="flex justify-center items-center h-16 text-white">

                    <Button className="h-max"  style={{
...
export const GamePage = () => {
    ...
    if (task.game.type === 'Wordle') {
        return GameWrapper(navigate, fallbackRoute, sectionId, task, <div>Wordle game</div>);
    }

    return GameWrapper(navigate, fallbackRoute, sectionId, task, <div>Unknown task</div>);
};
