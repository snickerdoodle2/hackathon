...
const Info: React.FC = () => {
  ...
  const jsonData = {
    "infos": {
      "Czym jest BIT": "Koło naukowe BIT to przede wszystkim miejsce, gdzie studenci AGH mogą rozwijać swoje zainteresowania i się nimi dzielić. Znajdziemy tutaj ludzi zainteresowanych nowoczesnymi metodami tworzenia oprogramowania, aktualnymi technologiami webowymi, a także algorytmami czy sztuczną inteligencją.",
      "Komu pomagamy": "Oprócz rozwijania swoich pasji, dzielimy się też wiedzą z zakresu studiów, prowadząc zajęcia wprowadzające w dziedziny matematyki i informatyki dla osób, które wcześniej nie miały z danymi zagadnieniami styczności. Wszystko po to, żeby wymienić się doświadczeniem i szybciej oraz lepiej przygotować się na zajęcia na uczelni.",
    },
    "youtube": "https://www.youtube.com/embed/dQw4w9WgXcQ",
    "links": {
      "Więcej o KN BIT": "https://knbit.edu.pl",
      "Linkedin": "www.linkedin.com/company/bit-scientific-group-at-agh-university",
    }
  };
      ...
      return (
        <div className="mt-8">
          ...
          <ul className="list-none">
            {Object.entries(jsonData.links).map(([text, url], index) => (
              <li key={index}>
  ...
  return (
    <div className="info-window px-8 py-8 max-w-screen-lg mx-auto">
      <button className="back-button absolute top-4 left-8 bg-none border-none text-xl font-bold" onClick={handleBackClick}>
        ←
      </button>
      <div className="content mt-12">
        ...
        <Button className="read-button block mx-auto mt-8 px-4 py-2 bg-blue-500 text-white font-bold rounded cursor-pointer" onClick={handleReadClick}>
          Przeczytałem
        </Button>
      </div>
    </div>
